    ...
    public class Pathes
    {
        ...
        private static class GearItem_ManualStart
        {
            internal static void Postfix(GearItem __instance)
            {
                ...
                if(__instance.name == "GEAR_SCDoorKey")
                {
        ...
        {
            if (MyMod.RebootSceneAfterSave)
            {
                MyMod.RebootSceneAfterSave = false;
                MelonLogger.Msg("[SaveGameSystem] SaveCompletedInternal RebootSceneAfterSave");
                string sceneToLoad = GameManager.m_SceneTransitionData.m_SceneSaveFilenameCurrent;
                GameManager.m_SceneTransitionData.m_SpawnPointName = null;
                GameManager.m_SceneTransitionData.m_SpawnPointAudio = null;
                GameManager.m_SceneTransitionData.m_ForceSceneOnNextNavMapLoad = null;
                GameManager.m_SceneTransitionData.m_ForceNextSceneLoadTriggerScene = null;
                GameManager.m_SceneTransitionData.m_SceneLocationLocIDToShow = null;
                GameManager.m_SceneTransitionData.m_Location = null;
                GameManager.m_SceneTransitionData.m_PosBeforeInteriorLoad = new Vector3(0,0,0);
                GameManager.m_SceneTransitionData.m_SceneSaveFilenameNextLoad = sceneToLoad; 
            ...
            if (Sav != null)
            {
                ...
                int Hash = SaveGameSlots.LoadDataFromSlot(Sav.m_SaveSlotName, "global").GetHashCode();
                ...
                int Hash = SaveGameSlots.LoadDataFromSlot(name, "global").GetHashCode();
                MelonLogger.Msg("[SaveGameSystem] Save hash: " + Hash);
